...
public class Movement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Debug.DrawRay(transform.position, transform.forward * 50f, Color.green, 0.5f); //Draws a ray forward in the direction the enemy is facing
        Debug.DrawRay(transform.position, directionToTarget, Color.red, 0.5f); //Draws a ray in the direction of the current target waypoint
